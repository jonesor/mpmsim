testthat::expect_error(calculate_errors(mat_U = 1))
testthat::expect_error(calculate_errors(mat_F = 1))
...
# if sample_size is a list of two matrices matrix, it must be the same as mat_U
testthat::expect_error(
  calculate_errors(
    mat_U = matrix(c(0.3, 0.2, 0.2, 0.1), nrow = 2, ncol = 2),
    mat_F = matrix(c(0.0, 2.2, 0.0, 0.0), nrow = 2, ncol = 2),
