test_that("function works correctly for all mortality_model types, uniform
  ...
  expect_silent(
    rand_leslie_set(
      ...
      mortality_params = data.frame(minVal = c(0, 0.01),
                                    maxVal = c(0.14, 0.15)),
  ...
  expect_silent(
    rand_leslie_set(
      ...
      mortality_params = data.frame(minVal = c(0.1, 0.2, 0.1),
  ...
  expect_silent(
    rand_leslie_set(
      ...
      mortality_params = data.frame(minVal = c(1.4, 0.18),
                                    maxVal = c(1.7, 0.28)),
      fertility_params = data.frame(minVal = c(4), maxVal = c(4)),
      fertility_maturity_params = c(0, 0), dist_type = "uniform",
      output = "Type5"
  ...
  expect_silent(
    rand_leslie_set(
      ...
      fertility_model = "step",
      mortality_params = data.frame(minVal = c(1.1, 0.05, 0.2),
...
test_that("function works correctly for all mortality_model types,
  ...
  expect_silent(
    rand_leslie_set(
      n_models = 5, mortality_model = "Gompertz", fertility_model = "step",
      mortality_params = data.frame(meanVal = c(0.1, 0.1),
                                    sdVal = c(0.01, 0.05)),
  ...
  expect_silent(
    rand_leslie_set(
      n_models = 5, mortality_model = "GompertzMakeham",
      fertility_model = "step",
      mortality_params = data.frame(meanVal = c(0.14, 0.25, 0.12),
  ...
  expect_silent(
    rand_leslie_set(
      n_models = 5, mortality_model = "Weibull", fertility_model = "step",
      mortality_params = data.frame(meanVal = c(1.7, 0.28),
                                    sdVal = c(.01, 0.01)),
      fertility_params = data.frame(meanVal = c(4), sdVal = c(.4)),
  ...
  expect_silent(
    rand_leslie_set(
      n_models = 5, mortality_model = "WeibullMakeham",
      fertility_model = "step",
      mortality_params = data.frame(meanVal = c(1.3, 0.15, 0.3),
...
test_that("function works correctly for all fertility_model types,
  ...
  expect_silent(
    rand_leslie_set(
      ...
      mortality_params = data.frame(minVal = c(0, 0.01),
                                    maxVal = c(0.14, 0.15)),
      fertility_params = data.frame(minVal = c(10, 0.5, 8),
                                    maxVal = c(12, 1.5, 10)),
      fertility_maturity_params = c(0, 0), dist_type = "uniform",
      output = "Type5"
    )
  ...
  expect_silent(
    rand_leslie_set(
      ...
      mortality_params = data.frame(minVal = c(0, 0.01),
                                    maxVal = c(0.14, 0.15)),
      fertility_params = data.frame(minVal = c(10, 0.3),
                                    maxVal = c(12, 0.8)),
      fertility_maturity_params = c(0, 0), dist_type = "uniform",
      output = "Type5"
    )
  ...
  expect_silent(
    rand_leslie_set(
      ...
      mortality_params = data.frame(minVal = c(0, 0.01),
                                    maxVal = c(0.14, 0.15)),
      fertility_params = data.frame(minVal = c(10, 4, 2),
                                    maxVal = c(12, 8, 3)),
      fertility_maturity_params = c(0, 0), dist_type = "uniform",
      output = "Type5"
    )
...
test_that("function works correctly for all fertility_model types,
  ...
  expect_silent(
    rand_leslie_set(
      n_models = 5, mortality_model = "Gompertz", fertility_model = "step",
      mortality_params = data.frame(meanVal = c(0.14, 0.15),
                                    sdVal = c(0.014, 0.015)),
  ...
  expect_silent(
    rand_leslie_set(
      ...
      mortality_params = data.frame(meanVal = c(0.14, 0.15),
                                    sdVal = c(0.014, 0.015)),
      fertility_params = data.frame(meanVal = c(12, 1.5, 10),
                                    sdVal = c(1.2, .15, .10)),
      fertility_maturity_params = c(0, 0), dist_type = "normal",
      output = "Type5"
    )
  ...
  expect_silent(
    rand_leslie_set(
      ...
      mortality_params = data.frame(meanVal = c(0.14, 0.15),
                                    sdVal = c(0.014, 0.015)),
      fertility_params = data.frame(meanVal = c(12, 8, 3),
                                    sdVal = c(.12, .8, .3)),
      fertility_maturity_params = c(0, 0), dist_type = "normal",
      output = "Type5"
    )
...
test_that("fertility_params validation works", {
  expect_error(rand_leslie_set(
    ...
    mortality_params = data.frame(minVal = c(0, 0.01),
                                  maxVal = c(0.14, 0.15)),
    fertility_params = data.frame(minVal = c(10, 0.5),
                                  maxVal = c(11, 0.9)),
    fertility_maturity_params = c(0, 0), dist_type = "uniform", output = "Type5"
  ))
  expect_error(rand_leslie_set(
...
test_that("mortality_params validation works", {
  expect_error(rand_leslie_set(
    n_models = 5, mortality_model = "Gompertz", fertility_model = "step",
    mortality_params = data.frame(minVal = c(0, 0.01, .2),
