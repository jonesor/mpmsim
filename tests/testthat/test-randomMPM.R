...
testthat::expect_error(
  randomMPM(n_stages = 4, fecundity = 5, archetype = 0, split = FALSE)
)

testthat::expect_error(
  randomMPM(n_stages = 4, fecundity = 5, archetype = 5, split = FALSE)
)

testthat::expect_error(
  randomMPM(n_stages = 4, fecundity = 5, archetype = 1.5, split = FALSE)
)
