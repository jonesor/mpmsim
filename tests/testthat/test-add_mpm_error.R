...
testthat::expect_error(
  add_mpm_error_indiv(
    mat_U = as.vector(mats$mat_U), mat_F = mats$mat_F,
...
testthat::expect_error(
  add_mpm_error_indiv(
    mat_U = mats$mat_U, mat_F = as.vector(mats$mat_F),
    sample_size = ssMat, split = TRUE
  )
)
...
testthat::expect_error(
  add_mpm_error_indiv(
    mat_U = mats$mat_U, mat_F = matrix(2,
...
testthat::expect_error(
  add_mpm_error_indiv(
    mat_U = mats$mat_U, mat_F = matrix(5,
...
testthat::expect_error(
  add_mpm_error_indiv(
    mat_U = mats$mat_U, mat_F = mats$mat_U,
    sample_size = matrix(10, nrow = 4, ncol = 4), split = TRUE
  )
)
...
testthat::expect_error(
  add_mpm_error_indiv(
    ...
    sample_size = list(
      ...
      mat_Y_ss = matrix(10, nrow = 3, ncol = 3), split = TRUE
    )
  )
)
...
testthat::expect_error(
  add_mpm_error_indiv(
    mat_U = mats$mat_U, mat_F = mmats$mat_U,
    sample_size = 10, split = "Yes"
  )
)
...
testthat::expect_error(
  add_mpm_error(
    mat_U = mats$mat_U, mat_F = mats$mat_U,
    sample_size = 10, split = FALSE, by_type = TRUE
  )
)
...
testthat::expect_type(
  add_mpm_error(
    mat_U = mats$mat_U, mat_F = mats$mat_U,
    sample_size = 0, by_type = TRUE
  ), "list"
)
testthat::expect_type(
  add_mpm_error(
    mat_U = mats$mat_U, mat_F = mats$mat_U,
    sample_size = 0, by_type = FALSE
  ), "list"
)
