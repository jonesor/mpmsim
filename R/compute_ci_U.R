...
#' the U submatrix of a matrix population model using parametric bootstrapping. In this approach a
#' sampling distribution of the U submatrix is generated by
...
#' assumption that survival-related processes are binomial (see the function `add_mpm_error()` for details).
#'
