...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------|
| [![License: GPL v3](https://img.shields.io/badge/License-GPL%20v3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0.html)                                                                                | [![R-CMD-check](https://github.com/jonesor/mpmsim/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/jonesor/mpmsim/actions/workflows/R-CMD-check.yaml.yaml) |              |
...
#> $A_list[[1]]
#>             [,1]       [,2]       [,3]      [,4]
#> [1,] 0.683817095 0.07436408 0.40352369 3.0190505
#> [2,] 0.065426834 0.57796228 0.03221829 0.1655543
#> [3,] 0.002387016 0.24212237 0.07486204 0.5271301
#> [4,] 0.064758332 0.01273125 0.05122861 0.2238208
#> 
#> $A_list[[2]]
#>             [,1]      [,2]       [,3]       [,4]
#> [1,] 0.004719656 0.3348849 0.40387912 6.27662294
#> [2,] 0.128065308 0.3286158 0.09015260 0.09244601
#> [3,] 0.427166249 0.1241865 0.23033102 0.10502351
#> [4,] 0.019221780 0.1375705 0.08540422 0.07442567
#> 
#> $A_list[[3]]
#>            [,1]       [,2]       [,3]      [,4]
#> [1,] 0.13142886 0.56014076 0.03765468 8.2803291
#> [2,] 0.47796787 0.20166801 0.12569645 0.1171839
#> [3,] 0.01832387 0.00426959 0.66699351 0.3060712
#> [4,] 0.01184625 0.09086567 0.09119377 0.0438874
#> 
#> $A_list[[4]]
#>            [,1]        [,2]       [,3]       [,4]
#> [1,] 0.23046148 0.183227044 0.68851806 6.36699301
#> [2,] 0.09507294 0.001175577 0.07291332 0.11467588
#> [3,] 0.50611523 0.262006976 0.12849628 0.01109936
#> [4,] 0.01556241 0.107666011 0.04314266 0.05970144
#> 
#> $A_list[[5]]
#>             [,1]       [,2]        [,3]       [,4]
#> [1,] 0.124409734 0.16562576 0.005851048 9.19474143
#> [2,] 0.109222906 0.01030503 0.359592193 0.17404735
...
#> $U_list[[1]]
#>             [,1]       [,2]       [,3]      [,4]
#> [1,] 0.683817095 0.07436408 0.40352369 0.0190505
#> [2,] 0.065426834 0.57796228 0.03221829 0.1655543
#> [3,] 0.002387016 0.24212237 0.07486204 0.5271301
#> [4,] 0.064758332 0.01273125 0.05122861 0.2238208
#> 
#> $U_list[[2]]
#>             [,1]      [,2]       [,3]       [,4]
#> [1,] 0.004719656 0.3348849 0.40387912 0.27662294
#> [2,] 0.128065308 0.3286158 0.09015260 0.09244601
#> [3,] 0.427166249 0.1241865 0.23033102 0.10502351
#> [4,] 0.019221780 0.1375705 0.08540422 0.07442567
#> 
#> $U_list[[3]]
#>            [,1]       [,2]       [,3]      [,4]
#> [1,] 0.13142886 0.56014076 0.03765468 0.2803291
#> [2,] 0.47796787 0.20166801 0.12569645 0.1171839
#> [3,] 0.01832387 0.00426959 0.66699351 0.3060712
#> [4,] 0.01184625 0.09086567 0.09119377 0.0438874
#> 
#> $U_list[[4]]
#>            [,1]        [,2]       [,3]       [,4]
#> [1,] 0.23046148 0.183227044 0.68851806 0.36699301
#> [2,] 0.09507294 0.001175577 0.07291332 0.11467588
#> [3,] 0.50611523 0.262006976 0.12849628 0.01109936
#> [4,] 0.01556241 0.107666011 0.04314266 0.05970144
#> 
#> $U_list[[5]]
#>             [,1]       [,2]        [,3]       [,4]
#> [1,] 0.124409734 0.16562576 0.005851048 0.19474143
#> [2,] 0.109222906 0.01030503 0.359592193 0.17404735
#> [3,] 0.007652419 0.39395405 0.491292690 0.51713935
#> [4,] 0.011558679 0.29005229 0.074311694 0.01453069
#> 
