...
Let's examine the Lefkovitch matrix that matches the Leslie matrix and life table from the previous seections:
...
recovered_life_tables[[i]] <- Rage::mpm_to_table(matU = m1$matU, matF = m1$matF, 
                                           remove_final = TRUE)
}
```
...
plot(df1$b_1_values, df1$lifespan_diff_perc, type = "b", 
