...
In addition to these functional forms of mortality, there are, of course, functional forms that have been used to model reproductive output (e.g. fertility/fecundity). The `model_reproduction` function (and its synonyms `model_fedundity` and `model_fertility`) handles five types: logistic, step, von Bertalanffy, Normal and Hadwiger.
...
stepMod <- baseDF %>%
  mutate(fert = model_reproduction(
