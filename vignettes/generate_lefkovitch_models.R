...
## -----------------------------------------------------------------------------
rand_lefko_mpm(n_stages = 3, reproduction = 5, archetype = 2)
...
rand_lefko_mpm(
  n_stages = 3, reproduction = list(lower_reprod, upper_reprod),
  archetype = 2
)

## -----------------------------------------------------------------------------
myMatrices <- rand_lefko_set(
  n = 100, n_stages = 3, reproduction = 12,
...
myMatrices <- rand_lefko_set(
  n = 100, n_stages = 3, reproduction = 12, constraint = constrain_df,
  archetype = 4, output = "Type1"
)
