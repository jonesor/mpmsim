...
To allow a random element to reproduction, users can provide reproductive output information as a list of two matrices of numeric values, both with the same dimension as `n_stages`, to provide lower and upper limits of mean fecundity for the entire matrix model. reproductive output values are then drawn from a uniform distribution between the two values. Users should use 0 for both lower and upper limits in cases with no reproduction.
