---
title: "Generating Lefkovitch matrices"
date: "`r Sys.Date()`"
output: 
  rmarkdown::html_vignette: default
  pdf_document: default
vignette: >
  %\VignetteIndexEntry{Generating Lefkovitch matrices}
...
To introduce variability in reproduction, users can provide reproductive output as a list of two matrices, with numeric values of the same dimensions as `n_stages`, representing the lower and upper limits of mean reproduction for the entire matrix model. Reproductive output values are then drawn from a uniform distribution between the two values. Users should use 0 for both lower and upper limits in cases with no reproduction.
